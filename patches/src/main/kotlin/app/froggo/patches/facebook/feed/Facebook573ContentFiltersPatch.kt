    ...
    execute {
        feedEdgeInsertion.method.addInstructions(
            ...
            """
                ...
                move-result-object v0
                instance-of v1, v0, Lcom/facebook/graphql/model/GraphQLStory;
                if-eqz v1, :froggo_combo573_recommendation
                check-cast v0, Lcom/facebook/graphql/model/GraphQLStory;
                invoke-virtual {v0}, Lcom/facebook/graphql/model/GraphQLStory;->A0W()LX/41R;
                move-result-object v0
                if-eqz v0, :froggo_combo573_recommendation
                const v1, 0x723ea5fe
                invoke-virtual {v0, v1}, LX/41R;->getCachedBoolean(I)Z
                move-result v0
                if-eqz v0, :froggo_combo573_recommendation
                ...
                :froggo_combo573_recommendation
                move-object/from16 v0, p2
                invoke-virtual {v0}, Lcom/facebook/graphql/model/GraphQLFeedUnitEdge;->BO4()LX/3S1;
                move-result-object v0
                const v1, -0x91415ea
                invoke-static {v0, v1}, LX/41T;->A00(Ljava/lang/Object;I)Z
                move-result v0
                if-eqz v0, :froggo_combo573_done

                const-string v0, "FroggoFeedDiag573"
                const-string v1, "candidate type=DiscoverFeedUnit"
                invoke-static {v0, v1}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I
                ...
                move-result-object v0
                if-eqz v0, :froggo_combo573_no_hideable
                const-string v0, "FroggoFeedDiag573"
                const-string v1, "discover hideableTokenPresent=1"
                invoke-static {v0, v1}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I
                goto :froggo_combo573_tracking

                :froggo_combo573_no_hideable
                const-string v0, "FroggoFeedDiag573"
                const-string v1, "discover hideableTokenPresent=0"
                invoke-static {v0, v1}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

                :froggo_combo573_tracking
                move-object/from16 v0, p2
                invoke-virtual {v0}, Lcom/facebook/graphql/model/GraphQLFeedUnitEdge;->BO4()LX/3S1;
                move-result-object v0
                check-cast v0, LX/41T;
                ...
                move-result-object v0
                if-eqz v0, :froggo_combo573_no_tracking
                const-string v0, "FroggoFeedDiag573"
                const-string v1, "discover trackingPresent=1"
                invoke-static {v0, v1}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I
                goto :froggo_combo573_done

                :froggo_combo573_no_tracking
                const-string v0, "FroggoFeedDiag573"
                const-string v1, "discover trackingPresent=0"
                invoke-static {v0, v1}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

                :froggo_combo573_done
                nop
            """.trimIndent(),
        )
