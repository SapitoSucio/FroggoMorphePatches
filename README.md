...
> **[v1.2.0-dev.11](https://github.com/SapitoSucio/FroggoMorphePatches/releases/tag/v1.2.0-dev.11)**&nbsp;&nbsp;•&nbsp;&nbsp;`dev`&nbsp;&nbsp;•&nbsp;&nbsp;9 patches total
<details open>
...
|----------|----------------|-----------|
| [Block Facebook Story ads (573)](#block-facebook-story-ads-573) | Pre-release experiment: filters Story ad buckets immediately after the Story Ads provider returns. |  |
